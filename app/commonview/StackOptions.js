...
const StackOptions = ({navigation}, title = "", showTitle = false, leftTitle = "返回", showLeft = true, rightTitle = "", showRight = false,
                      rightClick = () => {}) => {
    let headerTitle = showTitle ? title : null;
    let headerBackColor = (navigation.state.params.data) ? navigation.state.params.data.color : '#2888ff';
    let headerStyle = {height: scaleSize(80), backgroundColor: headerBackColor};
    ...
    return {headerTitle, headerStyle, headerRight, headerLeft, headerTitleStyle};
};
